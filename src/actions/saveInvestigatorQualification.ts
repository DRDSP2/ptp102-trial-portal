  ...
  return action('saveInvestigatorQualification', 'SQL', {
    ...
    query: `
      INSERT INTO investigator_qualifications (
        ...
        drug_storage_photo_url, emergency_equipment_photo_url, housing_photo_url, feed_photo_url,
        housing_comments, feed_comments, facility_checklist, investigator_agreement_signed, investigator_agreement_signed_at,
      ...
      VALUES (
        ...
        {{params.housingPhotoUrl}}, {{params.feedPhotoUrl}},
        {{params.housingComments}}, {{params.feedComments}}, {{params.facilityChecklist}}::jsonb,
      ...
      ON CONFLICT (veterinarian_id) DO UPDATE SET
        ...
        housing_photo_url = EXCLUDED.housing_photo_url,
        feed_photo_url = EXCLUDED.feed_photo_url,
        housing_comments = EXCLUDED.housing_comments,
        feed_comments = EXCLUDED.feed_comments,
